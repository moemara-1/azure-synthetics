	...
	<section class="opt-page-hero">
		<div class="opt-container opt-page-hero__grid">
			<div>
				...
				<p><?php esc_html_e( 'Answers about certificates, storage, shipping, calculator use, and product policy.', 'azure-synthetics' ); ?></p>
			</div>
			<div class="opt-specimen-panel">
				...
				<dl class="opt-specimen-table">
					<div><dt><?php esc_html_e( 'Certificates', 'azure-synthetics' ); ?></dt><dd><?php esc_html_e( 'Request through support', 'azure-synthetics' ); ?></dd></div>
