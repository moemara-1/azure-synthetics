...
<section class="azure-editorial-section azure-editorial-section--light">
	<div class="azure-shell azure-editorial-section__grid">
			<div class="azure-editorial-section__copy">
				<p class="azure-kicker"><?php esc_html_e( 'Why buyers switch', 'azure-synthetics' ); ?></p>
				<h2><?php esc_html_e( 'Less guessing. More buying signal.', 'azure-synthetics' ); ?></h2>
				<p><?php esc_html_e( 'The catalog keeps price, amount, pack size, purity target, COA path, shipping review, and support close to the decision.', 'azure-synthetics' ); ?></p>
				<p class="azure-meta-line"><?php esc_html_e( 'Made for people already comparing suppliers.', 'azure-synthetics' ); ?></p>
			</div>
