...
function azure_synthetics_ar_translations() {
	return array(
		...
		'Source research-use peptides with lot-aware CoA context, clear vial formats, and storage notes visible before checkout.' => 'وفّر ببتيدات للاستخدام البحثي مع سياق CoA مرتبط بالدفعة، وصيغ فيالات واضحة، وملاحظات تخزين ظاهرة قبل الدفع.',
		'Research purchasing proof points' => 'نقاط إثبات الشراء البحثي',
		'Lot-linked CoA context' => 'سياق CoA مرتبط بالدفعة',
		'Storage guidance before checkout' => 'إرشادات التخزين قبل الدفع',
