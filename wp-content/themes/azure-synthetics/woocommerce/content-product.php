	...
	<article class="azure-product-card<?php echo esc_attr( $card_mod ); ?>">
		...
		<div class="azure-product-card__meta">
			<?php if ( $product->is_featured() ) : ?>
				<span class="azure-badge"><?php esc_html_e( 'Popular', 'azure-synthetics' ); ?></span>
			<?php endif; ?>
			<?php if ( $product->is_type( 'variable' ) ) : ?>
				<span class="azure-badge"><?php esc_html_e( 'Vial + box value', 'azure-synthetics' ); ?></span>
			<?php endif; ?>
			<?php if ( $purity ) : ?>
				<span class="azure-badge"><?php echo esc_html( azure_synthetics_translate_string( $purity ) ); ?></span>
			<?php endif; ?>
		</div>
